...
from pycolite.formula import transform_eventually
...
if __name__ == '__main__':
    yacc_i = Parser()
    variable = yacc_i.parse("! (! fail1_48 & G (fail1_48 -> X fail1_48) & ! fail2_45 & G (fail2_45 -> X fail2_45) & ! fail3_31 & G (fail3_31 -> X fail3_31) & ! fail4_36 & G (fail4_36 -> X fail4_36) & ! fail_r1_15 & G (fail_r1_15 -> X fail_r1_15) & ! fail_r2_15 & G (fail_r2_15 -> X fail_r2_15)) | G (! fail1_48 & ! fail4_36 -> F ! (c5_5 & c6_5)) #fiu")
    print variable 
    variable = transform_eventually(variable, 5, False, True)
