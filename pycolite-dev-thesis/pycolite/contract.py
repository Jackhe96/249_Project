...
from pycolite.formula import Literal, Conjunction, Disjunction, Negation, transform_eventually
...
class Contract(object):
    ...
    def simplify_guarantees(self, n, orthogonalize=False):
        '''
        Does transformation on guarantee formula
        '''
        #print "simplify_guarantees called with orthogonalize= "+str(orthogonalize)
        #print self.guarantee_formula.generate()
        self.guarantee_formula = transform_eventually(self.guarantee_formula, n, False, orthogonalize)
        #print self.guarantee_formula.generate()
...
if __name__ == "__main__":
    print "Running test"
    C = Contract("test", [],["p0"],"true","F p0 & ! F p0")
    C.simplify_guarantees(5, True)