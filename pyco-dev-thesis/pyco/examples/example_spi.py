...
class Spec1bit_OR(Contract):
    ...
    ASSUMPTIONS = '''!req & G(req -> (X !req & X2 !req & X3 !req & X4 !req))'''
    GUARANTEES = '''G(req -> ((X2 !ready & X3 !ready & X4 ready) | 
                              (X2 !ready & X3 !ready & X4 !ready & X5 ready) | 
                              (X2 !ready & X3 !ready & X4 !ready & X5 !ready & X6 ready)) )&
                    G(req -> (
                              ( ((X4 adcbit_0) <-> anbit_0))  |
                              ( ((X4 adcbit_0) <-> X anbit_0)  ) |
                              ( ((X4 adcbit_0) <-> X2 anbit_0)  ) |
...
class Spec2bit_OR(Contract):
    ...
    ASSUMPTIONS = '''!req & G(req -> (X !req & X2 !req & X3 !req & X4 !req   ))'''
    GUARANTEES = '''G(req -> (  (X !ready & X2 !ready & X3 !ready & X4 ready) |
                                (X !ready & X2 !ready & X3 !ready & X4 !ready & X5 ready)  |
                                (X !ready & X2 !ready & X3 !ready & X4 !ready & X5 !ready & X6 ready) )) &
                    G(req -> (
