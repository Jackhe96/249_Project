...
def test_adc1_OR(spi_lib1):
    '''
    Performs simple synthesis
    '''

    spec1 = Spec1bit_OR('G1')
    # spec1 = Spec2bit('G1')
    #spec1 = Spec3bit('G1')
    # spec1 = Spec('G1')
    # spec1 = SpecIncremental('G1')
...
def test_adc2_int(spi_lib2_int, transform, orthogonalize):
    '''
    Performs simple synthesis
    '''
...
def test_adc2_int_OR(spi_lib2_int, transform, orthogonalize):
    '''
    Performs simple synthesis
    '''
...
def test_adc3_int(spi_lib3_int):
    ...
    interface.use_connected_spec(adc, 'analog', 'analog')
    # interface.synthesize(max_depth=4, library_max_redundancy=1)
    #interface.transform_eventually(10)
    interface.synthesize(max_depth=4, library_max_redundancy=1, decompose=False)
...
def test_adc4_int(spi_lib4_int, transform):
    '''
    Performs simple synthesis
    '''
    ...
    # interface.synthesize(max_depth=4, library_max_redundancy=1)
    if(transform > 0):
        print "\nTransforming F into " + str(transform) + " disjointed X operations"
        interface.transform_eventually(transform)
    interface.synthesize(max_depth=4, library_max_redundancy=1, decompose=False)
