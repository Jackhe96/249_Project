...
def test_synth_6_10_dc_9spec(acdc_lib, min_comps, min_ports, library_redundancy, filename, plain, transform, orthogonalize):
    '''
    Performs simple synthesis
    '''
    spec1 = GenIsolation1D('G1')
    ...
    # print "synthesizing without LTL transformation"
    # for _ in range(0, REP):
    #     interface.synthesize(strict_out_lib_map=False,
    #                      library_max_redundancy=library_redundancy,
    #                      limit=10,
    ...
    if(transform >= 0):
        if(not orthogonalize):
            ...
            print "\nTransforming F into X" + str(transform) 
